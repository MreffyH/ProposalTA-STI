...
Pada kondisi saat ini, sebagian besar UKM masih menggunakan pendekatan tradisional dalam menyusun anggaran. Proses perencanaan dan pengendalian anggaran umumnya merujuk pada empat tahapan utama, yakni penentuan pedoman anggaran, persiapan anggaran, penentuan anggaran, dan pelaksanaan anggaran \autocite{mekari2025}.
Pada tahap awal, pedoman anggaran disusun oleh pemilik usaha berdasarkan anggaran tahun sebelumnya. Selanjutnya, tahap persiapan anggaran dilakukan dengan menentukan kebutuhan masing-masing untuk pemasaran, produksi, dan operasional.
Tahap penentuan anggaran kemudian dilakukan dengan penelaahan dokumen tanpa ada mekanisme validasi otomatis, tahap ini sering memakan waktu lama dan rentan terjadi inkonsistensi antarbagian.
Pada tahap pelaksanaan anggaran, laporan realisasi tidak secara langsung terhubung dengan perencanaan anggaran yang telah dibuat sehingga monitoring dan evaluasi kinerja tidak dapat dilakukan secara \textit{real-time}. Dampaknya, banyak UKM mengalami kesulitan dalam mengontrol pengeluaran, menganalisis perubahan, maupun memperbarui strategi berdasarkan kondisi keuangan terkini.
