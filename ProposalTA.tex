...
\begin{center}
    ...
    {\Large\bfseries IMPLEMENTASI AI BERBASIS RAG UNTUK PERENCANAAN ANGGARAN USAHA KECIL DAN MENENGAH}\\
     \vspace{4cm}
...
% LEMBAR PENGESAHAN 
% ==========================================
\includepdf[pages=-]{LEMBAR PENGESAHAN.pdf}
% \newpage
% \thispagestyle{empty}
