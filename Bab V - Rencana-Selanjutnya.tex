...
Bagian ini akan embahas mengenai lini masa pengerjaan tugas akhir. Setiap periode menggambarkan fokus kegiatan utama yang akan dikerjakan hingga tahap implementasi dan evaluasi. 

\begin{longtable}{|p{3cm}|p{3cm}|p{7cm}|}
\caption{Linimasa Pengerjaan}
\label{tbl:Linimasa} \\
\hline
\textbf{Waktu} & \textbf{Fase} & \textbf{Kegiatan} \\
\hline
\endfirsthead

\hline
\textbf{Waktu} & \textbf{Waktu} & \textbf{Kegiatan} \\
\hline
\endhead
...
-
&
Cari topik, diskusi awal, dan finalisasi arah proposal tugas akhir.
\\ \hline

Oktober – Desember 2025
&
\textit{Business Understanding and Data Understanding}
&
finalisasi kebutuhan dan kriteria sukses, pengumpulan dan pemahaman data
\\ \hline

Januari – Juni 2026
&
\textit{Data Preparation, Modeling, Evaluation, Deployment}
&
pemilihan dokumen dan knowledge base,
implementasi RAG dan workflow otomasi,
verifikasi fungsional dan evaluasi kualitas RAG,
penerapan prototipe dengan dilakukan monitoring
\\ \hline
\end{longtable}


\section{Biaya Implementasi}
...
Bagian ini mendeskripsikan metrik, prosedur, dan kriteria penerimaan untuk mengevaluasi kualitas sistem RAG. Evaluasi dilakukan pada fase \textit{Evaluation} CRISP-DM dan hasilnya dipakai untuk iterasi perbaikan. Evaluasi dibagi menjadi empat bagian yaitu \textit{Retrieval}, \textit{Generation}, \textit{End-to-End}, dan \textit{Human Evaluation} \autocite{adilnaib2025}.
...
\begin{longtable}{|p{5cm}|p{7cm}|p{5cm}|}
\caption{Human Evaluation}
\label{tbl:Human Evaluation} \\
\hline
\textbf{Evaluasi} &  \textbf{Deskripsi}\\
\hline
\endfirsthead
...
\begin{longtable}{|p{1.5cm}|p{2.5cm}|p{1.8cm}|p{1.8cm}|p{6cm}|}
